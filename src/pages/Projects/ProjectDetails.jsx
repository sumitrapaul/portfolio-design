...
const ProjectDetails = () => {
  ...
  return (
    <div className="mt-12">
        <h2 className="text-2xl font-bold mb-6">Name: {project.name}</h2>
        <div>
    
            <h2 className="font-bold text-xl mb-10 "><span className="text-4xl text-red-900">Features :</span> {project.features}</h2>
